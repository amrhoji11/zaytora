...
const COPY = {
  ar: {
    title: "هل أنت متأكد من حذف جميع رسائل الدعم؟",
    body: "سيتم حذف جميع الرسائل نهائياً. لا يمكن التراجع عن هذا الإجراء.",
    delete: "حذف الكل",
    cancel: "إلغاء",
  },
  en: {
    title: "Delete all support messages?",
    body: "All messages will be permanently removed. This action cannot be undone.",
    delete: "Delete all",
    cancel: "Cancel",
  },
};

export function SupportMessagesDeleteAllDialog({
  open,
  language,
  deleting,
  onConfirm,
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm leading-relaxed text-body-foreground">{t.body}</p>
