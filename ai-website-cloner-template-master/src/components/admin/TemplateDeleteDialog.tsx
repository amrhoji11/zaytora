...
const COPY = {
  ar: {
    ...
    body: (code: string) =>
      `سيتم حذف القالب "${code}" نهائياً وإخفاؤه فوراً من كتالوج القوالب والاستوديو. لا يمكن التراجع عن هذا الإجراء.`,
    delete: "حذف",
    cancel: "إلغاء",
  },
  en: {
    ...
    body: (code: string) =>
      `"${code}" will be permanently removed and hidden from the templates catalog and Studio immediately. This action cannot be undone.`,
    delete: "Delete",
    cancel: "Cancel",
  },
};
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm leading-relaxed text-body-foreground">{t.body(code)}</p>
